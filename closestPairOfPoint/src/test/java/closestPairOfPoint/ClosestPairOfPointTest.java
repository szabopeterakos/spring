...
public class ClosestPairOfPointTest {
    ...
    File inputfile3_100 = new File("src/main/resources/sample_input_3_1000.tsv");
    String outputfile3_100 = "223:-532230\t-121034\t-172064\n" +
            "388:-540627\t-121936\t-185821\n";

    File inputfile4_4 = new File("src/main/resources/sample_input_4_4.tsv");
    String outputfile4_4 = "2:-543447\t-319599\t130119\t42410.4\n" +
            "3:-800188\t58364\t586736\t-409415\n";

    File inputfile10_100 = new File("src/main/resources/sample_input_10_100.tsv");
    String outputfile10_100 = "40:666272\t527672\t152967\t520180\t670892\t101834\t800325\t-292876\t-956374\t511728\n" +
    ...
    public void MatchesInput100_100Test() {
        ...
        assertEquals(result, output100_100);
    }

    @Test
    public void MatchesInput2_8Test() {
        String result = cpp.mainLogic(inputfile2_8);
        assertEquals(result, outputfile2_8);
    }

    @Test
    public void MatchesInput3_100Test() {
        String result = cpp.mainLogic(inputfile3_100);
        assertEquals(result, outputfile3_100);
    }

    // some places I found double values, like 42410.4 instead of 42410 in output file!!!
    @Test
    public void MatchesInput4_4Test() {
        String result = cpp.mainLogic(inputfile4_4);
        assertEquals(result, outputfile4_4);
    }

    @Test
    public void MatchesInput10_100Test() {
